...
local file="${1}"
test ! -f "${file}" && return
local lite_content="$(cat ${file} | grep -Ev '#\@\?#|\$\@\$|#\%#|#\@\%#|#\@\$\?#|#\$\?#|#\$#|#\?#|##\+js\(|#\%#\/\/scriptlet|redirect=|\,replace=|redirect-rule=|\$badfilter|\$document|\$empty|\$generichide|\$match-case|\$media|\$object|\$object-subrequest|\$popup|\$subdocument|\$~badfilter|\$~document|\$~empty|\$~generichide|\$~match-case|\$~media|\$~object|\$~object-subrequest|\$~popup|\$~subdocument|\,badfilter$|\,badfilter\,|\,document$|\,document\,|\,empty$|\,empty\,|\,generichide$|\,generichide\,|\,match-case$|\,match-case\,|\,media$|\,media\,|\,object$|\,object-subrequest$|\,object-subrequest\,|\,object\,|\,popup$|\,popup\,|\,subdocument$|\,subdocument\,|\,~badfilter$|\,~badfilter\,|\,~document$|\,~document\,|\,~empty$|\,~empty\,|\,~generichide$|\,~generichide\,|\,~match-case$|\,~match-case\,|\,~media$|\,~media\,|\,~object$|\,~object-subrequest$|\,~object-subrequest\,|\,~object\,|\,~popup$|\,~popup\,|\,~subdocument$|\,~subdocument\,|\$csp|\,csp=|\,denyallow=|\:matches-path' | sed 's/\$important$//g;s/\$important,/\$/g;s/\,important\,//g;s/\,important$//g;s/\$~important$//g;s/\$~important,/\$/g;s/\,~important\,//g;s/\,~important$//g' | sort | uniq)"
